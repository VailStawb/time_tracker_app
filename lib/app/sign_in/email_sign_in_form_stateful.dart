...
class _EmailSignInFormStatefulState extends State<EmailSignInFormStateful> {
  ...
  List<Widget> _buildChildren() {
    ...
    bool submitEnabled =
        widget.emailValidator.isValid(_email) && widget.passwordlValidator.isValid(_password) && !_isLoading;
  ...
  TextField _buildPasswordTextField() {
    bool showErrorText = _submitted && !widget.passwordlValidator.isValid(_password);
    return TextField(
